...
var peter = User(name: "Peter", age: 23, height: 190, weight: 110, activityLevel: 6)
print("Hi, I'm \(peter.name), I have \(peter.age) years old. I'm \(peter.height) tall and I weigh \(peter.weight) kg. I rate my activity level on \(peter.activityLevel)/10")
...
var anotherDistance = Distance(feet: 5249.344)
print("Meters: \(anotherDistance.meters)")
print("Feet: \(anotherDistance.feet)")

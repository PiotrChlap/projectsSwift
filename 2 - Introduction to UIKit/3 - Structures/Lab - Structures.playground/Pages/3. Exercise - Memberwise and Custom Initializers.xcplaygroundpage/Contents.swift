...
var favouriteBook = Book(title: "Hobbit, tam i z powrotem", author: "J.R.R. Tolkien", pages: 600, price: 65.34)
print("title: \(favouriteBook.title), author: \(favouriteBook.author), pages: \(favouriteBook.pages), price: \(favouriteBook.price)")
...
var firstLaptop = Laptop(yearConstructed: 2021)
var secondLaptop = Laptop(screenSize: 16, repairCount: 2, yearConstructed: 2013)
...
var myHeight = Height(heightInCentimeters: 150)

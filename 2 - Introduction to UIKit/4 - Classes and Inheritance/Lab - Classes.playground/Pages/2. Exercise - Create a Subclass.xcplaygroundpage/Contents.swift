...
class Fighter: Spaceship {
    var weapon: String = ""
    var remaingingFirePower: Int = 5
    func fire() {
        if remaingingFirePower > 0 {
            remaingingFirePower -= 1
        } else {
...
destroyer.remaingingFirePower = 10
...
//Because falcon is Falcon class without property weapon. It is only superclass.
...
destroyer.fire()
print(destroyer.remaingingFirePower)
destroyer.fire()
print(destroyer.remaingingFirePower)
destroyer.fire()
print(destroyer.remaingingFirePower)

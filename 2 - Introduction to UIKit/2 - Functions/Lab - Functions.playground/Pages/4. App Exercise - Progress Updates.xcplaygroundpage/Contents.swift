...
progressUpdate(steps: 560, goal: 10000)
progressUpdate(steps: 1500, goal: 10000)
progressUpdate(steps: 6000, goal: 10000)
progressUpdate(steps: 9560, goal: 10000)
progressUpdate(steps: 12030, goal: 10000)

//:  Your fitness tracking app is going to help runners stay on pace to reach their goals. Write a function called pacing that takes four `Double` parameters called `currentDistance`, `totalDistance`, `currentTime`, and `goalTime`. Your function should calculate whether or not the user is on pace to hit or beat `goalTime`. If yes, print "Keep it up!", otherwise print "You've got to push it just a bit harder!"
func pacing(currnetDistance: Double, totalDistance: Double, currentTime: Double, goalTime: Double) {
    if currentTime/currentTime > totalDistance/goalTime {
        print("Keep it up!")
    } else {
        print("You've got to push it just a bit harder!")
    }
}
pacing(currnetDistance: 500, totalDistance: 2000, currentTime: 34, goalTime: 50)
